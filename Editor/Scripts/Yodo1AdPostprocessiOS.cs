    ...
    public class Yodo1PostProcessiOS
    {
        ...
        private static List<string> DynamicLibraryPathsToEmbed
        {
            get
            {
                ...
                if (Yodo1AdUtils.IsAppLovinValid(Yodo1PlatfromTarget.iOS))
                {
                    dynamicLibraryPathsToEmbed.Add(Path.Combine("Pods/", "AppLovinSDK/applovin-ios-sdk-13.3.1/AppLovinSDK.xcframework"));
                    // Amazon
                ...
                if (Yodo1AdUtils.IsValidWithNetwork(Yodo1PlatfromTarget.iOS, "Pubmatic"))
                {
                    ...
                    dynamicLibraryPathsToEmbed.Add(Path.Combine("Pods/", "OpenWrapSDK/OpenWrapSDK/OpenWrapSDK.xcframework"));
                }
                ...
                // TaurusX
                if (Yodo1AdUtils.IsValidWithNetwork(Yodo1PlatfromTarget.iOS, "TaurusX"))
                {
                    dynamicLibraryPathsToEmbed.Add(Path.Combine("Pods/", "TaurusxAdsSDK/TaurusxAdsSDK.xcframework"));
                }

                // Tencent
                if (Yodo1AdUtils.IsValidWithNetwork(Yodo1PlatfromTarget.iOS, "Tencent"))
                {
